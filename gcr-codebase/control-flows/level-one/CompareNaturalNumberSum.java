...
// Create CompareNaturalNumberSum class to find the sum of n natural numbers and compare the result with the formulae n*(n+1)/2
public class CompareNaturalNumberSum{
	public static void main(String args[]){
		...
		if(number > 0){
			...
			// Intialize a variable sum to zero and find the sum of n natural number using while loop
			int sum = 0;
			int i = 1;
			while(i <= number){
				sum += i;
